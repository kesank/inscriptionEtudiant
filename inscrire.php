    ...
    <div class="bloc_page">
        ...
        <center>
    		...
    		<form method="POST" action="inscrire.php">
                ...
                <input type="text" name="matricule" id="matricule" placeholder="Ex:242355765" size="80%" autofocus maxlength="20" required><br/><br>

    			<label for="nom" class="identifie"> Nom* </label><br>
                <input type="text" name="nom" id="nom" placeholder="Ex:Nka"size="80%" required><br/><br>

    			<label for="prenom" class="identifie"> Prenom* </label> <br>
                <input type="text" name="prenom" id="prenom" placeholder="Ex:kelly"size="80%" required ><br/><br>

    			<label for="email" class="identifie"> Email </label><br>
                <input type="email" name="email" id="email"placeholder="Ex:kelly@gmail.com"size="80%"><br/><br>

    			<label for="telephone" class="identifie">Téléphone </label><br>
                <input type="tel" name="telephone" id="telephone" placeholder="Ex:0634569067" size="80%" required><br/><br>
    		   ...
    		   <div>
                   <div class="liste">
                    ...
                    <div class="liste">
                        ...
                        <input type="date" name="naissance" id="naissance" placeholder="Ex:JJ-MM-AAAA">
                    </div>
                </div>
